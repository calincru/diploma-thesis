...
\begin{figure}[h]
  ...
  \caption{Modelling a simple router that only forwards packets based on its
  routing table.}
...
straightforward, but also the most inefficient one. That being said, we will
not cover the more advanced and better performing ones here.
